          ...
          >
            ...
            <div className="z-10 flex flex-col justify-between h-full">
              ...
              <p className="text-xs text-gray-500">
                Китепканалар: <span className="font-semibold text-slate-700">{reg.count}</span>
              </p>
            </div>
            ...
            >
              {/* Градиент затемнения (исчезает при наведении) */}
              <div 
                className="absolute inset-0 bg-gradient-to-r from-white via-white/80 to-black/70 transition-opacity duration-500 ease-in-out group-hover:opacity-0 opacity-100"
              ></div>
            </div>
          </div>
        ))}
