  ...
  const notifications = [
    {
      id: 1,
      title: "Новый отчёт",
      text: "Добавлен новый месячный отчёт.",
      time: "5 минут назад",
    },
    {
      id: 2,
      title: "Обновление",
      text: "Данные библиотеки были обновлены.",
      time: "1 час назад",
    },
    {
      id: 3,
      title: "Напоминание",
      text: "Не забудьте заполнить статистику.",
      time: "2 часа назад",
    },
  ];
          ...
          <div className="flex items-center justify-between border-b border-gray-100 px-5 py-4">
            <div>
              ...
              <p className="mt-0.5 text-sm text-gray-400">
                У вас {notifications.length} новых уведомления
              </p>
            </div>
